...
| | answer_bad|answer_median | answer_good|
|---|---|---|---|
| 回答|公司要辞退你的话，可能跟当地的自治条例有关系，具体我也不太清楚细则。甘南那边是自治州，应该会有一些自己的规定，但大概还是按照国家劳动法来的。你可以看看公司是不是有正当理由，比如你犯了错或者经济裁员什么的。不过也有可能不合法，要看情况。建议你去问问当地劳动局，或者找个人咨询一下。 | 根据《甘肃省甘南藏族自治州自治条例》第一条的规定，甘南藏族自治州的自治条例是依据《中华人民共和国宪法》《中华人民共和国民族区域自治法》《甘肃省实施〈中华人民共和国民族区域自治法〉若干规定》及相关法律法规制定的，适用于本州的经济、政治、文化和社会活动。在处理劳动合同解除等具体事务时，应结合本州实际情况和相关法律法规执行。 | 公司解除合同必须有合法理由并书面说明依据。如在试用期解除，须证明你“不符合录用条件”，且该条件需在入职时明确告知并有书面记录。正式员工解除则需符合法定情形，如严重违纪、不能胜任工作等，且程序合法。\n建议保存劳动合同、岗位职责、考勤记录、解除通知等证据。若公司无合法理由解除，可向当地劳动争议仲裁委员会申请仲裁，要求恢复劳动关系或支付赔偿金。|
|信息准确性	|模糊表述（“可能有关系”“大概按劳动法”），无具体依据	|准确引用《自治条例》第一条，明确地方法规定位，但未落地到 “劳动合同解除”	|既覆盖国家《劳动合同法》核心条款（试用期 / 正式员工解除条件），又给出可操作的证据保存、维权路径|
|用户价值	|无实质帮助（仅 “建议问劳动局”，未提供前置判断依据）	|解答了 “地方法规依据” 的疑问，但未解决 “如何处理解除纠纷” 的核心诉求|	直接回应 “公司解除是否合法”“该怎么做”，覆盖用户从 “判断” 到 “行动” 的全需求|
|专业性	|表述模糊、无法律条款支撑	|有法规引用，但仅停留在 “宏观依据”，无具体应用场景落地	|结合劳动纠纷场景，精准拆解法律条款 + 实操步骤，专业性强|
