...
TrainLoss = []
TestLoss = []
TrainLoss.append(evaluateRerankerModel(model, train_dataloader, token_true_id, token_false_id))
TestLoss.append(evaluateRerankerModel(model, test_dataloader, token_true_id, token_false_id))
...
for epoch in tqdm(range(n_epoch), desc="Training"):
    ...
    testloss = evaluateRerankerModel(model, test_dataloader, token_true_id, token_false_id)
